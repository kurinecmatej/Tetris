...
/**
 * Trieda charakterizujuca tvar pismena Z
 * 
...
public class ZShape extends Shape {
    ...
    /**
     * konstruktor triedy ZShape. Vytvrenie noveho tvaru
    ...
    public void moveLeft() {
        ...
        switch (rotation) {
            ...
            case SOUTH:
                ...
                break;
            case EAST:
                if (!(getCenterX() > 0 && board.getBoard()[getCenterY() - 1][getCenterX()] == 0
                        && board.getBoard()[getCenterY()][getCenterX() - 1] == 0
                        && board.getBoard()[getCenterY() + 1][getCenterX() - 1] == 0)) {
                    return;
                }
    ...
    public void rotateLeft() {
        ...
        switch (rotation) {
            case NORTH:
                ...
                break;
            case SOUTH:
                if (board.getBoard()[getCenterY() - 1][getCenterX() + 1] == 0 &&
                        board.getBoard()[getCenterY()][getCenterX() + 1] == 0) {
                    nullShape();
    ...
    public void createShape() {
        ...
        switch (rotation) {
            case NORTH:
                board.getBoard()[getCenterY() - 1][getCenterX()] = 7;
                board.getBoard()[getCenterY() - 1][getCenterX() - 1] = 7;
                board.getBoard()[getCenterY()][getCenterX()] = 7;
                board.getBoard()[getCenterY()][getCenterX() + 1] = 7;
                break;
            case SOUTH:
                board.getBoard()[getCenterY() + 1][getCenterX() + 1] = 7;
                board.getBoard()[getCenterY()][getCenterX() - 1] = 7;
