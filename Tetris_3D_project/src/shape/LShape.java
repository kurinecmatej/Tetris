...
/**
 * Trieda charakterizujuca tvar pismena L
 * 
...
public class LShape extends Shape {
    ...
    /**
     * konstruktor triedy LShape. Vytvrenie noveho tvaru
    ...
    public void rotateLeft() {
        ...
        switch (rotation) {
            ...
            case EAST:
                ...
                break;
            case WEST:
                if (getCenterY() + 1 < board.getBoardHeight() && board.getBoard()[getCenterY() - 1][getCenterX() - 1] == 0
                        && board.getBoard()[getCenterY() - 1][getCenterX()] == 0
                        && board.getBoard()[getCenterY() + 1][getCenterX()] == 0) {
                    nullShape();
    ...
    public void createShape() {
        ...
        switch (rotation) {
            case NORTH:
                board.getBoard()[getCenterY() - 1][getCenterX()] = 2;
                board.getBoard()[getCenterY()][getCenterX()] = 2;
                board.getBoard()[getCenterY() + 1][getCenterX()] = 2;
                board.getBoard()[getCenterY() + 1][getCenterX() + 1] = 2;
                break;
            case SOUTH:
                board.getBoard()[getCenterY() - 1][getCenterX()] = 2;
                board.getBoard()[getCenterY() - 1][getCenterX() - 1] = 2;
                ...
                break;
            case EAST:
                board.getBoard()[getCenterY()][getCenterX() - 1] = 2;
                board.getBoard()[getCenterY()][getCenterX()] = 2;
                board.getBoard()[getCenterY()][getCenterX() + 1] = 2;
                board.getBoard()[getCenterY() + 1][getCenterX() - 1] = 2;
                break;
